  ...
  <head>>
    ...
    <style>
      ...
      body{
        ...
        color: #333;
        fonot-family: "Nunito Sans", Helvetica, Arial, sans-serif;
      }
      ...
      <div class="content-box">
        <img
          ...
          <div class="highlight-box>
           ...
           <p>
            If you made this request, click the button belowe to choose a new password.
            <strong>This link only valid for the next 24 hours.</strong>
          </p>
          ...
          <p class="sub">
            If the button doesn't work, copy and paste this link into your browswer:
            <br />
...
export const successRestTemplate = `!DOCTYPE html>
<html lang="en">
  <head>
      <meta charset="UTF-8"  />
      <meta name="viewport" content="width"=device-width, initial-scale=1.0" />
